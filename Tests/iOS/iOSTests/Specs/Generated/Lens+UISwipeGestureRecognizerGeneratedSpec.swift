...
//
//  Lens+UISwipeGestureRecognizerGeneratedSpec.swift
//  iOSTests
//
...
class LensUISwipeGestureRecognizerProtocolGeneratedSpec: QuickSpec {
    override func spec() {
        describe("Lens+UISwipeGestureRecognizerGeneratedSpec") {
